...
continuous_features = ['age', 'num_emp', 'weeks_worked', 'own_or_self', 'vet_benefits']
binary_features = ['is_mig_universe', 'is_child', 'is_family_match', 'is_investor']

ohe_features = [
    'hs_college', 'mig_same',           
    'marital_stat', 'union_member', 'tax_filer_stat', 
    'major_ind_code', 'major_occ_code',
    'sex', 'race',        
    'full_or_part_emp',  
    'class_worker',       
    'det_hh_fam_stat',    
    ...
    'mig_chg_msa', 'mig_prev_sunbelt', 'vet_question', 'unemp_reason', 'hisp_origin'
]
...
very_soft_preprocessing_pipeline = Pipeline([
    ...
    ('selection', SelectKBest(score_func=f_classif, k=100))
])